...
<link href="<?php echo base_url()?>assets/css/modifiy.css" rel="stylesheet">
			...
			<div class="diary">
				<form action="" method="post">
					...
					<div id="title">
						...
						<input type="text" name="title" value="<?=$dd->title?>">
					</div>
					<div id="info">
					...
					<hr>
					<div id="content">
						<textarea name="content" id="myTextarea"><?=$dd->content?></textarea>
					</div>
